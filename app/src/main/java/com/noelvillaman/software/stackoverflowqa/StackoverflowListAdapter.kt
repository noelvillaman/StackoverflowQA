...
class StackoverflowListAdapter (val mContext : Context, private val questionList : ArrayList<QuestionObjectStackoverflow>) : RecyclerView.Adapter<StackoverflowListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.questionBody.text = questionList[position].questionBody
